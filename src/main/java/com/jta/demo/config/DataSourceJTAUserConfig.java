...
@MapperScan(basePackages = "com.jta.demo.domain.mapper.user", sqlSessionTemplateRef = "jtaUserSqlSessionTemplate")
public class DataSourceJTAUserConfig {
    ...
    public SqlSessionFactory jtaUserSqlSessionFactory(@Qualifier("dataSourceJTAUser") DataSource dataSource)
        ...
        bean.setTypeAliasesPackage("com.jta.demo.domain.mapper.user");
