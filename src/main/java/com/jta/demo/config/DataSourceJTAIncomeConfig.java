...
@MapperScan(basePackages = "com.jta.demo.domain.mapper.income", sqlSessionTemplateRef = "jtaIncomeSqlSessionTemplate")
public class DataSourceJTAIncomeConfig {
    ...
    public SqlSessionFactory jtaIncomeSqlSessionFactory(@Qualifier("dataSourceJTAIncome") DataSource dataSource)
        ...
        bean.setTypeAliasesPackage("com.jta.demo.domain.mapper.income");
